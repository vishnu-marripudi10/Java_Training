...
mysql> select * from customers_details inner join account_details on customers_details.AccountNumber = account_details.AccountNumber where OpeningDate > '2020-08-15';
+---------------+-------------------+------------------+----------------+-------------+---------------+----------+
| AccountNumber | CustomerFirstName | CustomerLastName | CustomerNumber | OpeningDate | AccountNumber | City     |
+---------------+-------------------+------------------+----------------+-------------+---------------+----------+
|           103 | Rajesh            | Babu             |              4 | 2020-08-20  |           103 | banglore |
...
mysql> select * from customers_details inner join account_details on customers_details.AccountNumber = account_details.AccountNumber where OpeningDate > '2020-08-15' order by CustomerNumber;
+---------------+-------------------+------------------+----------------+-------------+---------------+----------+
| AccountNumber | CustomerFirstName | CustomerLastName | CustomerNumber | OpeningDate | AccountNumber | City     |
+---------------+-------------------+------------------+----------------+-------------+---------------+----------+
|           103 | Rajesh            | Babu             |              4 | 2020-08-20  |           103 | banglore |
...
mysql> select CustomerFirstName from customers_details inner join account_details on customers_details.AccountNumber = account_details.AccountNumber group by CustomerFirstName having Count(City) order by CustomerFirstName;
+-------------------+
| CustomerFirstName |
+-------------------+
| PremSai           |
...
mysql> select count(CustomerNumber) as Count_CustomerNumber from customers_details inner join account_details on customers_details.AccountNumber = account_details.AccountNumber where CustomerNumber not in (select CustomerNumber from account_details);
+----------------------+
| Count_CustomerNumber |
+----------------------+
|                    0 |
